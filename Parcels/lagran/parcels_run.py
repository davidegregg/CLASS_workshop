...
tlon=87 #target lon - must be a number between -180 and 180 
tlat=13 #target lat - must be a number between -90 and 90 
tdepth=200 #target depth - must be a number between 2 and 5500 
...
homedir='/home/users/train023/Documents/CLASS_workshop/Parcels/lagran/data/' #replace YOURUSERNAME with your username e.g. trainXXX so that it points to your home directory ##'/home/user/YOURUSERNAME/'
outfile_name='output_5yrs' #choose a file name - do not includes spaces
